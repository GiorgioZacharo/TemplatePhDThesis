...
\textbf{Candidate} & \textbf{Ranking}  & \textbf{Ranking}   &  \textbf{Ranking}  \\
            & \textbf{}   & \textbf{(\rseeker)} & \textbf{(gprof)} \\ \hline  \hline
  residual-block-cavlc-16     &  1               &  1       &   4  \\ \hline 
  TrailingOnes-TotalCoeff     &  2               &  2       &   2    \\ \hline 
  inter-prediction-chroma     &  3               &  3       &   5     \\ \hline
...
eterogeneous Computing calls for specialized \HW\ (HW) that can serve the purpose of
both accelerating applications and saving significant amounts of energy.
...
accelerate or which parts to materialize in low power HW accelerators is not 
...
management are complex and hard to identify.
...
repeated for every considered candidate.

In order to address these challenges we present \eseeker, a methodology to
