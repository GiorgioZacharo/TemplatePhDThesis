...
% The -Oz
% compilation flag was used during compilation from the source code to
% the Intermediate Representation level, in order to avoid vectorization
% of the loops, which hinders a correct inspection of the loop
% features.\par
