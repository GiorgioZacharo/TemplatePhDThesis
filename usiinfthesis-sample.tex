...
use of different types of ports (e.g. High Performance) and buses, as well as combinations of loop unrolling and cyclic array partitioning factors in order to minimize the number of cycles required for the execution of loops.
\par
