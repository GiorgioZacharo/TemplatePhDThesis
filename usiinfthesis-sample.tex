...
systems).\par
  ...
  \includegraphics[width=.9\linewidth]{figs/figs_from_pptx/merit_estimation.pdf}
        \vskip -1em
  \caption{Estimation of hardware computation times at the basic block (a), function (b) and \candidate\ (c) levels.}
  \label{fig:hw-comp}
      \vskip -1.5em
\end{figure}
